...
![portfolio ](https://github.com/nipuni-udari/portfolio-NipuniUdari/assets/84343511/6a3a11ff-21f4-4750-bfed-06361ae3cd5c)
![portfolio 2](https://github.com/nipuni-udari/portfolio-NipuniUdari/assets/84343511/766bc6a0-350d-4376-96dd-be5ea4c7ff71)
...
- Navigate to `package.json` and enter your domain name instead of `https://nipuniudari.js.org/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/nipuni-udari`, add the same to the homepage section of `package.json`.

- In short you can also add `/nipuni-udari` to `package.json` as both are exactly same. Upon doing so, you tell `create-react-app` to add the path assets accordingly.
